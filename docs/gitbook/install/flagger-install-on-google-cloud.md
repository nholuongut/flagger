...
![GKE Cluster Overview](https://raw.githubusercontent.com/nholuongut/flagger/master/docs/diagrams/flagger-gke-istio.png)
...
Jetstack's [cert-manager](https://github.com/nholuongut/cert-manager) 
...
```bash
CERT_REPO=https://raw.githubusercontent.com/nholuongut/cert-manager
...
--version v0.7.0 \
nholuongut/cert-manager
```

### Istio Gateway TLS setup

![Istio Let&apos;s Encrypt](https://raw.githubusercontent.com/nholuongut/flagger/master/docs/diagrams/istio-cert-manager-gke.png)
