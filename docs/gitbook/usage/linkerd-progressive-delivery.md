...
![Flagger Linkerd Traffic Split](https://raw.githubusercontent.com/nholuongut/flagger/master/docs/diagrams/flagger-linkerd-traffic-split.png)
...
```bash
kubectl apply -k github.com/nholuongut/flagger//kustomize/tester
```

Create a deployment and a horizontal pod autoscaler:

```bash
kubectl apply -k github.com/nholuongut/flagger//kustomize/podinfo
```
...
```bash
kubectl -n test set image deployment/podinfo \
podinfod=nholuongut/podinfo:2.0.3
```
...
![Flagger Linkerd Ingress](https://raw.githubusercontent.com/nholuongut/flagger/master/docs/diagrams/flagger-nginx-linkerd.png)
...
```bash
kubectl -n test set image deployment/podinfo \
podinfod=nholuongut/podinfo:2.0.4
```
