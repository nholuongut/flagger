...
[Flagger](https://github.com/nholuongut/flagger) is a Kubernetes operator that automates the promotion of 
...
--- | --- | ---
`image.repository` | image repository | `nholuongut/flagger`
