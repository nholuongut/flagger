...
- Do not copy labels from canary to primary deployment [#178](https://github.com/nholuongut/flagger/pull/178)
...
- Add option to skip the canary analysis [#46](https://github.com/nholuongut/flagger/pull/46)
