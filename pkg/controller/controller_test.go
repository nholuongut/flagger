...
import (
	...
	"github.com/nholuongut/flagger/pkg/apis/flagger/v1alpha3"
	istiov1alpha1 "github.com/nholuongut/flagger/pkg/apis/istio/common/v1alpha1"
	istiov1alpha3 "github.com/nholuongut/flagger/pkg/apis/istio/v1alpha3"
	"github.com/nholuongut/flagger/pkg/canary"
	clientset "github.com/nholuongut/flagger/pkg/client/clientset/versioned"
	fakeFlagger "github.com/nholuongut/flagger/pkg/client/clientset/versioned/fake"
			...
			Template: corev1.PodTemplateSpec{
				...
				Spec: corev1.PodSpec{
					Containers: []corev1.Container{
						{
							Name:  "podinfo",
							Image: "quay.io/nholuongut/podinfo:1.2.0",
							Command: []string{
								"./podinfo",
								"--port=9898",
							},
